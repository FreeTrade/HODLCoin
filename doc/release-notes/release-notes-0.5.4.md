HODLCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hodlcoin/files/HODLCoin/hodlcoin-0.5.4/
...
http://gitorious.org/hodlcoin/hodlcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix HODLCoin-Qt notifications under Growl 1.3.
Increase required age of HODLCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHODLCoin properly when installing HODLCoin-Qt over it. (Windows)
