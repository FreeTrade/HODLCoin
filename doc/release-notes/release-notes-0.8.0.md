HODLCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hodlcoin/files/HODLCoin/hodlcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the HODLCoin
...
New/changed settings (command-line or hodlcoin.conf file)
--------------------------------------------------------
