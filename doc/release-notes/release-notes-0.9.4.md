HODLCoin Core version 0.9.4 is now available from:

  https://hodlcoin.org/bin/0.9.4/
...
this update is incompatible with the HODLCoin system and could lead to consensus
forks.

HODLCoin Core released binaries from https://hodlcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~hodlcoin/+archive/ubuntu/hodlcoin
- A third-party or self-compiled HODLCoin Core

upgrade to HODLCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
