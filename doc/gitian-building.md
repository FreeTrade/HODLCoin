...
*Setup instructions for a Gitian build of HODLCoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the HODLCoin
...
- [Building HODLCoin](#building-hodlcoin)
...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-hodlcoin-host/README.md).
...
Clone the git repositories for hodlcoin and Gitian.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the hodlcoin repository
...
To build HODLCoin (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md) in the hodlcoin repository.
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/hodlcoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/hodlcoin/hodlcoin
...
For example:
```bash
URL=https://github.com/laanwj/hodlcoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit hodlcoin=${COMMIT} --url hodlcoin=${URL} ../hodlcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit hodlcoin=${COMMIT} --url hodlcoin=${URL} ../hodlcoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit hodlcoin=${COMMIT} --url hodlcoin=${URL} ../hodlcoin/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/hodlcoin-linux-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/hodlcoin-win-build.assert
    gpg --detach-sign ${VERSION}-osx-unsigned/${SIGNER}/hodlcoin-osx-build.assert
```
...
[hodlcoin/gitian.sigs](https://github.com/hodlcoin/gitian.sigs/) repository, or if that's not possible create a pull
