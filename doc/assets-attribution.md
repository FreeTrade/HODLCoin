The following is a list of assets used in the hodlcoin source and their proper attribution.
...
* HODLCoin Icon: (based on the original hodlcoin logo from Bitboy)
* Some icons are based on Stephan Hutchings Typicons
* License: MIT

### Assets Used
    src/qt/res/icons/about.png, src/qt/res/icons/about_qt.png,
    src/qt/res/icons/hodlcoin.icns, src/qt/res/icons/hodlcoin.ico,
    src/qt/res/icons/hodlcoin.png, src/qt/res/icons/clock*.png,
    ...
    src/qt/res/src/verify.svg, src/qt/res/src/hodlcoin.svg,
