...
###   This script attempts to download the signature file SHA256SUMS.asc from hodlcoin.org
...
WORKINGDIR="/tmp/hodlcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://hodlcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://hodlcoin.org/bin/"
VERSIONPREFIX="hodlcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'hodlcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[hodlcoin-]<version>-[rc[0-9]] (example: hodlcoin-0.9.2-rc1)"
   echo "wget output:"
