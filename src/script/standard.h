...
#ifndef HODLCOIN_SCRIPT_STANDARD_H
#define HODLCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a CHODLCoinAddress
 */
...
#endif // HODLCOIN_SCRIPT_STANDARD_H
