...
#ifndef HODLCOIN_QT_HODLCOINUNITS_H
#define HODLCOIN_QT_HODLCOINUNITS_H
...
/** HODLCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HODLCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HODLCoinUnits(QObject *parent);

    /** HODLCoin units.
      @note Source: https://en.hodlcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        HODL,
...
private:
    QList<HODLCoinUnits::Unit> unitlist;
};
typedef HODLCoinUnits::Unit HODLCoinUnit;

#endif // HODLCOIN_QT_HODLCOINUNITS_H
