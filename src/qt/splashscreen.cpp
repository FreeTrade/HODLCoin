    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The HODLCoin Core developers"));
    ...
    // draw the hodlcoin icon, expected size of PNG: 1024x1024
