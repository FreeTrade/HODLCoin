...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("HOdlcoin Core hodlcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hodlcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hodlcoin transaction") + "\n" +
              "  hodlcoin-tx [options] -create [commands]   " + _("Create hex-encoded hodlcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hodlcoin transaction
