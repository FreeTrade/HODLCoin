...
#ifndef HODLCOIN_RPCPROTOCOL_H
#define HODLCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! HODLCoin is not connected
