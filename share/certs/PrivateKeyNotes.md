...
unlocked to sign the HODLCoin-Qt.app bundle.
...
allowing somebody to distribute a HODLCoin-Qt.app or hodlcoin-qt-setup.exe with a valid
...
that the hodlcoin-qt.exe file inside the installer had not been tampered with.
