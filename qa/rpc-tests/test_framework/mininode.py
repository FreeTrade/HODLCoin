# mininode.py - HODLCoin P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a hodlcoin node
...
# Objects that map to hodlcoind objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in hodlcoind indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest"):
        ...
        print 'MiniNode: Connecting to HODLCoin Node IP # ' + dstaddr + ':' \
            + str(dstport)
